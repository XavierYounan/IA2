...
async function requestArticles(){
    ...
    */ 
    ...
    for(var i=0; i<noSub; i++){
        //console.log(i)
        var articles = fakeArray[subjects[i]]
    ...
    for(var i=0; i<allArticlesLength; i++){
